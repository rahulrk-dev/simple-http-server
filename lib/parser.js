...
function onReason(_, from, size) {
	return getValue(this, 'reason', from, size)
}

function onMethod(_, from, size) {
	return getValue(this, 'method', from, size)
}

function onUrl(_, from, size) {
	return getValue(this, 'path', from, size)
}

function onProtocol(_, from, size) {
	return getValue(this, 'protocol', from, size)
}

function onVersion(_, from, size) {
	return getValue(this, 'version', from, size)
}

function onStatus(_, from, size) {
	return getValue(this, 'status', from, size)
}
